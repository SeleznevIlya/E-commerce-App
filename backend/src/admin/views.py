...
from src.products.models import ProductModel, CategoryModel
...
class CartProductAdmin(ModelView, model=CartProductModel):
    column_list = [CartProductModel.id, CartProductModel.product_id, CartProductModel.cart_id]
    can_delete = False
...
class OrderProductAdmin(ModelView, model=OrderProductModel):
    column_list = [OrderProductModel.order, 
